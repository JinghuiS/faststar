...
export const RecordContextProvider: React.FC<React.PropsWithChildren<{ record: BasicRecord }>> =
    React.memo((props) => {
        return (
            <RecordContext.Provider value={props.record}>{props.children}</RecordContext.Provider>
        )
    })
