...
export const ResourceContextProvider: React.FC<React.PropsWithChildren<{ resourceName: string }>> =
    React.memo(({ children, resourceName }) => {
        return <ResourceContext.Provider value={resourceName}>{children}</ResourceContext.Provider>
    })
