 ...
 *                    \-- data is Product
 */
export const useUpdate = <RecordType extends BasicRecord = any, MutationError = unknown>(
    resource?: string,
    ...
    >({
        ...
        onSuccess: (
            ...
            // console.log(callTimeId, callTimeResource, variables, data)
            updateCache({
...
> = UseMutationOptions<RecordType, MutationError, Partial<UseUpdateMutateParams<RecordType>>>
