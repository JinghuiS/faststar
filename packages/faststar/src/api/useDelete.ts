 ...
 *                    \-- data is Product
 */
export const useDelete = <RecordType extends BasicRecord = any, MutationError = unknown>(
    resource?: string,
...
export type UseDeleteResult<RecordType extends BasicRecord = any, MutationError = unknown> = [
    (
        resource?: string,
        params?: Partial<DeleteParams<RecordType>>,
