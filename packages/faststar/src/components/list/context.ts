...
const ListTableContext = React.createContext<ListTableContextProps>({} as ListTableContextProps)
...
export const { Provider: BatchSelectedIdsContextProvider, useContext: useBatchSelectedIdsContext } =
