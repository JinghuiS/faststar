import type { BasicFieldOptions, FieldDetailComponent, FieldEditComponent } from "./types"
...
export function createFieldFactory<CustomOptions extends {} = {}>(
    ...
    return (source: string, options?: BasicFieldOptions & CustomOptions): FieldHandler =>
        (viewType) => {
            if (viewType === "list") {
                return {
